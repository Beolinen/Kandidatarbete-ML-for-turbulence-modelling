...
plt.subplots_adjust(left=0.20, bottom=0.20)
fig3.colorbar(plt.contourf(x2d, y2d, abs(dudy_large + dvdx_large), 1000, cmap=plt.get_cmap("plasma")), ax=ax3, label="$||S_{ij}||$")
plt.axis([0, 4, -0.4, 1])
...
plt.subplots_adjust(left=0.20, bottom=0.20)
fig4.colorbar(plt.contourf(x2d, y2d, u2d_large, 1000, cmap=plt.get_cmap("plasma")), ax=ax4, label="$u(x,y)$")
plt.axis([0, 4, -0.4, 1])
...
plt.subplots_adjust(left=0.20, bottom=0.20)
fig5.colorbar(plt.contourf(x2d, y2d, v2d_large, 1000, cmap=plt.get_cmap("plasma")), ax=ax5, label="$v(x,y)$")
plt.axis([0, 4, -0.4, 1])
...
plt.subplots_adjust(left=0.20, bottom=0.20)
fig6.colorbar(plt.contourf(x2d, y2d, dudy_large, 1000, cmap=plt.get_cmap("plasma")), ax=ax6, label="$\partial u /\partial y$")
plt.axis([0, 4, -0.4, 1])
...
plt.subplots_adjust(left=0.20, bottom=0.20)
fig7.colorbar(plt.contourf(x2d, y2d, dvdx_large, 1000, cmap=plt.get_cmap("plasma")), ax=ax7, label="$\partial v /\partial x$")
plt.axis([0, 4, -0.4, 1])
...
plt.subplots_adjust(left=0.20, bottom=0.20)
fig8.colorbar(plt.contourf(x2d, y2d, uu2d, 1000, cmap=plt.get_cmap("plasma")), ax=ax8, label="uu2d")
plt.axis([0, 4, -0.4, 1])
...
plt.subplots_adjust(left=0.20, bottom=0.20)
fig9.colorbar(plt.contourf(x2d, y2d, dvdy_large, 1000, cmap=plt.get_cmap("plasma")), ax=ax9, label="$\partial v /\partial y$")
plt.axis([0, 4, -0.4, 1])
