...
# Scale data
duidxj_test_scaled = scaler.transform(duidxj_test_reshape)
k_scaled_2 = scaler.transform(k_scaled_reshape)
uv_2_scaled = scaler.transform(uv_2_reshape)
eps_2_scaled = scaler.transform(eps_2_reshape)
p2d_2_scaled = scaler.transform(p2d_2_reshape)
vv2d_2_scale = scaler.transform(vv2d_2_reshape)
uu2d_2_scale = scaler.transform(uu2d_2_reshape)
