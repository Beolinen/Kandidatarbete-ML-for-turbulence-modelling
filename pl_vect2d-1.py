...
plt.scatter(duidxj_test,cmy_DNS_large,marker = "o", s = 10, c = "green",label = "Target")
plt.scatter(duidxj_test,y_svr,marker = "o", s= 10, c = "blue", label = "Prediction")
plt.xlabel("$||S_{ij}||$")
...
#plt.contourf(x2d, y2d, cmy_DNS, 5)
fig1.colorbar(plt.contourf(x2d, y2d, cmy_DNS, 1000), ax=ax1, label = "$C_\mu$")
